  ...
  <header>
    <nav>
      ...
      <ul class="list">
        ...
        <router-link class="cursor-point" :to="{name: 'leaderboard'}">LEADERBOARD</router-link>
        <router-link v-if="!user" class="cursor-point" :to="{name: 'login'}">LOGIN</router-link>
        <router-link v-if='user' class="cursor-point" :to="{name: 'account'}">ACCOUNT</router-link>
        <router-link v-if='user' @click='logout' class="cursor-point" :to="{name: 'home'}">LOGOUT</router-link>
